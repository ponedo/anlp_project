...
import random
import itertools
from step3_get_dataset import load_dataset
...
def main(train=True):
    ...
    if train:
        ...
        #     random_state=0, solver='lbfgs', multi_class='multinomial', class_weight="balanced", verbose=1, max_iter=125)
